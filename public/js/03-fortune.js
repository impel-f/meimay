...
const FortuneLogic = (function () {
    ...
    const luckData = {
        ...
        27: { l: "吉", r: "意志が強く、自分の考えを貫く力があります。謙虚さと協調性を添えることで、周囲の信頼を得て伸びていく運勢です。" },
        28: { l: "凶", r: "才能豊かですが、環境の変化や移り変わりに翻弄されやすい運勢です。家族との絆を大切にしましょう。" },
        29: { l: "大吉", r: "知略と戦略に優れ、知的な分野で大きな成功を収めます。権力志向が強いですが、実力で地位を築きます。" },
        30: { l: "吉", r: "変化に富み、チャンスを掴む柔軟さを持っています。焦らず平常心を保つことで、流れを味方につけられる運勢です。" },
        ...
        42: { l: "吉", r: "多才で器用な力を持ち、幅広い分野で可能性を広げられます。目標を絞って粘り強く取り組むことで運が開けます。" },
        ...
        50: { l: "吉", r: "大きな流れの変化を受けやすい数です。成功した時こそ堅実さと謙虚さを大切にすれば、安定した運に育てられます。" },
        51: { l: "吉", r: "晩年になるほど運気が上昇し、穏やかで幸福な余生を送ることができます。焦らず着実に努力を続けましょう。" },
        52: { l: "大吉", r: "先見の明があり、時代の流れを読んで成功を収めます。投機的な才能もありますが、堅実さも忘れずに。" },
        53: { l: "吉", r: "華やかさと繊細さを併せ持つ運勢です。見栄を張らず、ありのままの魅力を大切にすることで良さが引き立ちます。" },
        54: { l: "凶", r: "孤立しやすく、周囲との協調性に欠ける傾向があります。和を大切にし、感謝の気持ちを表すことが開運の鍵です。" },
        55: { l: "吉", r: "チャンスを引き寄せる力があります。迷いすぎず自信を持って行動することで、良い流れを形にしていける運勢です。" },
