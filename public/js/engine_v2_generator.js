...
const NAME_PATTERNS = {
    male: {
        suffixes: [
            // 1 mora
            'と', 'き', 'や', 'た', 'ま', 'あ', 'く', 'し', 'ご', 'じ', 'る', 'は', 'お', 'さ', '也', '助', '平',
            // 2 moras
            'たろう', 'じろう', 'すけ', 'のしん', 'ひこ', 'よし', 'ひと', 'ろう', 'のすけ', 'あき', 'のり'
        ],
        prefixes: [
            'まさ', 'よし', 'たか', 'ひろ', 'かず', 'とし', 'かつ', 'きよ', 'みつ', 'やす', 'ひで', 'なお', 'そう'
        ]
    },
    female: {
        suffixes: [
            // 1 mora
            'な', 'か', 'み', 'こ', 'え', 'の', 'よ', 'り', 'き', 'ほ', 'あ', 'さ', 'ね', 'ゆ', 'わ', 'は'
        ],
        prefixes: [
            'ま', 'り', 'あ', 'か', 'ゆ', 'さ', 'な', 'み', 'ち', 'ひ', 'ほ'
        ]
    }
};
